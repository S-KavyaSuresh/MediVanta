    ...
    >
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="flex min-w-0 items-start gap-3 md:flex-1">
          ...
          {canSearch ? (
            ...
            <div className="min-w-0">
              <p className="text-sm font-semibold">{roleTitles[session.user.role]}</p>
        ...
        <div className="flex min-w-0 flex-wrap items-center gap-3 md:justify-end">
          ...
          <div
            className="flex min-w-0 items-center gap-3 rounded-2xl border border-[color:var(--border)] bg-[color:var(--surface)] px-3 py-2"

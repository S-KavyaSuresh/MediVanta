...
export default function LaboratoryProfilePage() {
  ...
  return (
    <RoleProfilePage
      ...
      title="Profile"
      description="Review the account identity currently linked to your laboratory workspace."
      initialDraft={{
      ...
      derivedValues={{
        ...
        department: session.user.departmentId
          ? `Laboratory / ${getDepartmentName(session.user.departmentId)}`
      ...
      fields={[
        ...
        { key: "department", label: "Laboratory / Department", type: "readonly", editable: false },
        { key: "designation", label: "Designation", type: "readonly", editable: false },
        { key: "qualifications", label: "Qualifications / Certifications", type: "readonly", editable: false },
